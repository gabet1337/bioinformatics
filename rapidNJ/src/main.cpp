...
/*void bootstrap(ostream &out){
  ...
  bootstrapper* bs = new bootstrapper(dl, options::fastdist, options::verbose, options::negative_branches);
  bs->run(out, options::replicates, numCores);  
}*/
